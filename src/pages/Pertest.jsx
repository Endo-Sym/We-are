    ...
    return(
        <div className=" w-full h-screen flex flex-col items-center border-black bg-[url('./assets/images/cartoon-bg.png')] bg-cover bg-fixed font-nunito ">
            ...
            <div className='flex flex-col items-center justify-center mt-20'>
                ...
                <textarea id="message" rows="10" class="block p-5 w-full  text-[18px] font-medium text-gray-900 border border-[#CE9EFF] shadow-[rgba(223,_28,_255,_0.6)_0px_0px_20px] rounded-[20px] bg-gradient-to-r from-[#FFFFFF] from-0% to-[#B770FF] to-89%  "></textarea>
                <button className='analyze  bg-white rounded-[16px] w-[70%] p-3 font-bold text-black mt-5 mb-2 px-20  transform motion-safe:hover:scale-105  ' type="button">Analyze</button>
