...
function Signin() {
    ...
    return (
        <div className="w-full h-[100vh] flex items-center justify-center border-black bg-[url('./assets/images/welcome-bg.png')] bg-cover font-poppins">
            <div className="flex flex-col items-center justify-between m-16 p-16 w-[600px] max-w-[600px] h-[80%] bg-black text-white border border-[#DF1CFF] shadow-[rgba(223,_28,_255,_0.6)_0px_0px_30px] relative rounded-[50px]">
                ...
                <h1 className="text-[64px] font-bold">Sign in</h1>
